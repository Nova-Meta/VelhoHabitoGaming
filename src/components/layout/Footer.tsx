      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          <div className="mt-2 md:mt-0">
            <Logo className="mb-4 [&_span]:text-white [&_.text-brand-orange]:text-brand-orange-light" />
        ...
        <div className="border-t border-white/10 mt-6 pt-3 text-center text-stone-400 text-xs space-y-1">
          <p>&copy; {new Date().getFullYear()} Velho Hábito Gaming Café. Todos os direitos reservados.</p>
          <p>
            Site desenvolvido pela{' '}
            <a
              href="https://novameta.pt"
              target="_blank"
              rel="noopener noreferrer"
              className="font-semibold text-brand-orange-light hover:text-brand-orange"
            >
              Nova Meta
            </a>
            .
